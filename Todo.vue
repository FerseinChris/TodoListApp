<template>
  <section class="todoapp">
    <header class="header">
      <h1>Todos</h1>
      <input type="text" class="new-todo" placeholder="Add a new Task" v-model="newTodo" @keyup.enter="addTodo">
    </header>
    <div class="main">
    ...
    <footer class="footer" v-show="hasTodos">
      <span class="todo-count"><strong>{{ remaining }}</strong>Task to do</span>
      <ul class="filters">
      ...
      <button class="clear-completed" v-show="completed" @click.prevent="deleteCompleted">Delete all tasks done</button>
    </footer>
  </section>
</template>
